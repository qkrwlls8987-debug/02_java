package com.jinosoft.section04.scanner;
...
public class Application01 {
  public static void main(String[] args) {
    ...
    String name = sc.next(); // 다음 입력된 첫 번째 토큰을 읽어와 문자열로 반환
    ...
    int age = sc.nextInt(); // 다음 입력된 첫 번째 토큰을 읽어와 int로 변환하여 반환
    System.out.println("age = " + age);

    /* 2-4. 실수 입력 받기 */
    /* 문자열 또는 double 범위 초과 시
     * java.util.InputMismatchException이 발생한다.
     * */
