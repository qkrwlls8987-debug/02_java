...
public class Application1 {
  public static void main(String[] args) {
    ...
    System.out.println("javaoracle : " + javaoracle); // pythonoracle


    String javaoracle1 = "javaoracle";

    /* length() : 문자열의 길이를 정수형으로 반환한다. */
    System.out.println("length() : " + javaoracle1.length());
