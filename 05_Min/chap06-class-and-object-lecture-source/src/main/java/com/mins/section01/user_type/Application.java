package com.mins.section01.user_type;
...
public class Application {
  public static void main(String[] args) {
    ...
    * */
    ...
    Member member = new Member(); // Member라는 객체를 생성 후 주소 참조
    ...
    * */
    ...
    // -> JVM이 각 자료형 기본값으로 초기화
    // * java - null : 참조하는 객체가 없다(주소 저장 X 의미)
