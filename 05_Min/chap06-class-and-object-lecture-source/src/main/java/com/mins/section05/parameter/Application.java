package com.mins.section05.parameter;
...
public class Application {
  public static void main(String[] args) {
    ...
    System.out.println("width : " +  r1.getHeight());

    /* 가변 인자 확인 */
    pt.testVariableLengthArrayParameter("홍길동", "도적질", "동에번쩍", "서에번쩍");
    pt.testVariableLengthArrayParameter("정진호", "스타벅스가기", "500만원 쓰기", "마카롱 사서 옆반 주기");
  }
}
