package com.mins.section05.overloading;
...
public class OverloadingTest {
  public static void main(String[] args) {
     ...
     *
     * 사용 이유
     * - 매개 변수의 종류에 따라서 메서드 동작이 조금씩 달라 지는 경우
     *   서로 다른 이름으로 메서드를 관리하면 어렵기 때문에
     *   하나의 이름으로 관리
     *
     *  성립 요건
     * 1. 메서드 이름이 갗아야 한다
     * 2. 매개변수의 타이브 순서, 개수 중 하나라도 달라야 한다
     * 3, 접근 제어자, 반환형, 예외처리 변경 X*/

    OverloadingTest overloadingTest = new OverloadingTest();
  }

  public void test(){} // 매개 변수 개수 다름
  public void test(int num){} // 매개 변수 개수 다름
  public void test(double num){} // 타입 다름
  public void test(String name, double num){} // 매개 변수 개수 다름
